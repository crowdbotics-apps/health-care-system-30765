...
## Project Structure
    ...
    ├── health_care_system_30765  # Django project configurations
...
1. Clone this repo and `cd health_care_system_30765`
...
2. Clone this repo and `cd health_care_system_30765`
